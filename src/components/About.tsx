	...
	return (
		<div className="mt-8 items-center justify-center md:mt-0">
			<section className="text-md grid w-full gap-4 rounded-lg bg-black bg-opacity-80 p-8">
				...
				<p>
					My name is Facundo and I’m a former Full-Stack web developer currently
					working at Take-off Media here on Uruguay.
				</p>
				<p>
					I started studying Computer Sciense on 2013 at UTU, which is a public
					high-school level institute where you get specialized on a certain
					carrer; there I learned basic infrastructure, networking, development
					with Java and MySQL.
				</p>
				<p>
				...
				<p>
					On 2019 I did a 3 month bootcamp of React and React Native on Hack
					Academy, where I fell in love with JavaScript and it’s ecosystem.
				</p>
				<p>
				...
				<p>
					...
					development to maintainance, with technologies such as Node.js, Vue
					JS, MongoDb, Docker, and many more.
				</p>
			</section>
		</div>
	);
